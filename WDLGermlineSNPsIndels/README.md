...
```
java -Dconfig.file=./backends/backend-local.conf -jar cromwell-<version>.jar run ./pipeline/WholeGenomeSequencingGATK4.wdl -i ./inputs/WholeGenomeSequencingGATK4.inputs.json -m metadata.json
```
