...
```
{
   ...
   "WholeExomeSequencingGATK4WF.refBaseDir":  ".../hg38/",
   "WholeExomeSequencingGATK4WF.refBaseName": "Homo_sapiens_assembly38",

   "WholeExomeSequencingGATK4WF.refFasta":    ".../hg38/Homo_sapiens_assembly38.fasta",
   "WholeExomeSequencingGATK4WF.refAlt":      ".../hg38/Homo_sapiens_assembly38.fasta.64.alt",
   "WholeExomeSequencingGATK4WF.refIndex":    ".../hg38/Homo_sapiens_assembly38.fasta.fai",
   "WholeExomeSequencingGATK4WF.refDict":     ".../hg38/Homo_sapiens_assembly38.dict",
   "WholeExomeSequencingGATK4WF.refAmb":      ".../hg38/Homo_sapiens_assembly38.fasta.amb",
   "WholeExomeSequencingGATK4WF.refAnn":      ".../hg38/Homo_sapiens_assembly38.fasta.ann",
   "WholeExomeSequencingGATK4WF.refBwt":      ".../hg38/Homo_sapiens_assembly38.fasta.bwt",
   "WholeExomeSequencingGATK4WF.refPac":      ".../hg38/Homo_sapiens_assembly38.fasta.pac",
   "WholeExomeSequencingGATK4WF.refSa":       ".../hg38/Homo_sapiens_assembly38.fasta.sa",

   "WholeExomeSequencingGATK4WF.dbSnpsVcf":                          ".../hg38/Homo_sapiens_assembly38.dbsnp138.vcf.gz",
   "WholeExomeSequencingGATK4WF.dbSnpsVcfIdx":                       ".../hg38/Homo_sapiens_assembly38.dbsnp138.vcf.gz.tbi",
   "WholeExomeSequencingGATK4WF.hapMapResourceVcf":                  ".../hg38/hapmap_3.3.hg38.vcf.gz",
   "WholeExomeSequencingGATK4WF.hapMapResourceVcfIndex":             ".../hg38/hapmap_3.3.hg38.vcf.gz.tbi",
   "WholeExomeSequencingGATK4WF.omniResourceVcf":                    ".../hg38/1000G_omni2.5.hg38.vcf.gz",
   "WholeExomeSequencingGATK4WF.omniResourceVcfIndex":               ".../hg38/1000G_omni2.5.hg38.vcf.gz.tbi",
   "WholeExomeSequencingGATK4WF.oneThousandGenomesResourceVcf":      ".../hg38/1000G_phase1.snps.high_confidence.hg38.vcf.gz",
   "WholeExomeSequencingGATK4WF.oneThousandGenomesResourceVcfIndex": ".../hg38/1000G_phase1.snps.high_confidence.hg38.vcf.gz.tbi",
   "WholeExomeSequencingGATK4WF.millsResourceVcf":                   ".../hg38/Mills_and_1000G_gold_standard.indels.hg38.vcf.gz",
   "WholeExomeSequencingGATK4WF.millsResourceVcfIndex":              ".../hg38/Mills_and_1000G_gold_standard.indels.hg38.vcf.gz.tbi",
   "WholeExomeSequencingGATK4WF.axiomPolyResourceVcf":               ".../hg38/Axiom_Exome_Plus.genotypes.all_populations.poly.hg38.vcf.gz",
   "WholeExomeSequencingGATK4WF.axiomPolyResourceVcfIndex":          ".../hg38/Axiom_Exome_Plus.genotypes.all_populations.poly.hg38.vcf.gz.tbi",

   "##CAMBIAR VALOR DE LAS 2 SIGUIENTES": "wgsCoverageIntervalList y wgsEvaluationIntervalList",
   "WholeExomeSequencingGATK4WF.wgsCoverageIntervalList":   ".../hg38/Homo_sapiens_assembly38.fasta.sa",
   "WholeExomeSequencingGATK4WF.wgsEvaluationIntervalList": ".../hg38/Homo_sapiens_assembly38.fasta.sa",

   "WholeExomeSequencingGATK4WF.knownIndelsSitesVcfs": [
      ".../hg38/Mills_and_1000G_gold_standard.indels.hg38.vcf.gz", 
      ".../hg38/Homo_sapiens_assembly38.known_indels.vcf.gz"
   ],
   "WholeExomeSequencingGATK4WF.knownIndelsSitesIndices": [
   ...
   "WholeExomeSequencingGATK4WF.intervalList": ".../hg38/wgs_calling_regions.hg38.interval_list",
   "WholeExomeSequencingGATK4WF.scatterCount": 5,
   "WholeExomeSequencingGATK4WF.breakBandsAtMultiplesOf": 1000000,
   "WholeExomeSequencingGATK4WF.intervalListOutDir": "intervalsDirectory",
   "WholeExomeSequencingGATK4WF.useGenomicsDB": true,
   ...
   "WholeExomeSequencingGATK4WF.fastqReadsTSV": ".../reads/read_pairs.tsv",
   ...
   "WholeExomeSequencingGATK4WF.bwaMemCommand_pairedSplit": "mem -K 100000000 -v 3 -t 2 -Y $bashRefFasta $bashReadFastq1 $bashReadFastq2",
   ...
   "WholeExomeSequencingGATK4WF.TSVIntervalsFile": ".../intervals.tsv",
   "WholeExomeSequencingGATK4WF.protectionTag": ":1+",
   ...
   "WholeExomeSequencingGATK4WF.resultsDir": ".../results",
   ...
   "WholeExomeSequencingGATK4WF.wfQC_PerSamplePerLane": false,
   ...
   "WholeExomeSequencingGATK4WF.wfQC_PerSample": false,
   ...
   "WholeExomeSequencingGATK4WF.javaOpts": "-Xmx8g -Xms8g"
}
```
